...
const Home = () => {
  ...
  useGSAP(()=>{
    ...
    tl.from('.three', { opacity: 0,x: -70, duration: .5, ease: 'power1.out' }, '0.5')
    .from('.two', { opacity: 0, x: -70, duration: .5, ease: 'power1.out' }, '-=0.3')
    .from('.seven', { opacity: 0, x: 70, duration: .5, ease: 'power1.out' }, '-=0.3')
    .from('.six', { opacity: 0, x: 70, duration: .5, ease: 'power1.out' }, '-=0.3')
    .from('.four', { opacity: 0, y:70 , duration: .5, ease: 'power1.out' }, '-=0.3')
    .from('.five', { opacity: 0, x: 70, duration: .5, ease: 'power1.out' }, '-=0.3')
  })
