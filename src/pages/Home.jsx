...
const Home = () => {
  ...
  return (
    <section className="h-screen w-screen overflow-auto">
      ...
      >
        {/* -------------------------------picture div ------------------------------- */}
        <div className="bg-[#18181b] text-white p-4 rounded-2xl md:col-span-3 md:row-span-3 md:col-start-6 md:row-start-3">
        ...
        {/* --------------------------------------identity div -------------------------------------- */}
        <div className="bg-[#0D3C52] text-white p-4 rounded-2xl md:col-span-4 md:row-span-2 md:col-start-2 md:row-start-3
        ...
        {/* ---------------------introduction div ------------------------------------------------------- */}
        <div className="bg-[#18181B] text-white p-5  rounded-2xl md:col-span-7 md:row-span-2 md:col-start-2">
        ...
        {/* --------------------------------------------technologies div -------------------------------------------- */}
        <div className="bg-[#18181B] text-white p-4 rounded-2xl md:col-span-4 md:row-span-5 md:col-start-2 md:row-start-5">
        ...
        {/* ------------------------------------------------galaxies div-------------------------------------------------------- */}
        <div className="bg-[#0D3C52] text-white  rounded-2xl md:col-span-3 md:row-span-3 md:col-start-9 hidden md:block">
          <img src="/public/galaxies.webp" className='h-full w-full  object-cover rounded-2xl ' alt="" />
        </div>
        {/* --------------------------------------------------------quotes div-------------------------------------------------------- */}
        <div className="relative bg-[#0D3C52] text-white p-4 rounded-2xl md:col-span-3 md:row-span-2 md:col-start-9 md:row-start-4 hidden  md:block">
